    ...
    <div className="min-h-dvh px-4 pb-[max(1.5rem,env(safe-area-inset-bottom,0px))] pt-[max(1rem,env(safe-area-inset-top,0px))] sm:px-6 sm:py-12">
      <div className="mx-auto min-w-0 max-w-2xl">
        ...
        <div className="mb-10 animate-fade-in sm:mb-12">
          ...
          <Link
            to="/dashboard"
            className="mt-3 mb-1 flex items-center gap-2 text-xs uppercase tracking-wider text-text-muted transition-colors hover:text-text"
          >
            <svg
        ...
        <div className="space-y-10 animate-fade-in animate-delay-200">
          <section>
            <h2 className="font-display text-base text-text">What is Deepcast?</h2>
          ...
          <section>
            <h2 className="font-display text-base text-text">Why does it exist?</h2>
            <p className="mt-3 text-sm leading-relaxed text-text-muted">
          ...
          <section>
            <h2 className="font-display text-base text-text">Who is it for?</h2>
            <p className="mt-3 text-sm leading-relaxed text-text-muted">
          ...
          <section>
            <h2 className="font-display text-base text-text">Who made this?</h2>
            <p className="mt-3 text-sm leading-relaxed text-text-muted">
              I did — Ien Chi (
              <a

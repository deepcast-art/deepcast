...
Deepcast is an invite-only social network for sharing films through word of mouth — the counter-bet to the attention economy. There is no feed, no algorithm, no public link: a film travels only because one person chose one other person and handed them a ticket. Viewers watch, then pass the film onward with their own small allotment of tickets, and the network that forms — who led the film to you, and who received it because of you — is itself the product. Founded and built by Ien Chi, a filmmaker who helped grow a YouTube channel to five million subscribers and watched platform incentives bend everything toward clickbait; Deepcast optimizes for resonance instead of reach.
...
- **The journey sentence counts your whole downstream.** *"This film has reached [X] people. [Y] of them received it because of you."* — where Y includes your invitees' shares, and theirs, to any depth, so your number grows when the film travels beyond you. With nothing shared yet: *"…Your shareable tickets are waiting to grow that number."* Numbers are always numerals. (This deliberately counts tickets issued, not tickets watched — the older "reach" stat that counts only opened invites survives on legacy surfaces; the difference is documented, not accidental.)

...
function headlineRow(text) {
  return row(`<p style="margin:0;font-family:${SERIF};font-style:italic;font-size:22px;line-height:1.35;color:${TEXT};">${escapeHtml(text)}</p>`, '0 0 28px 0')
}
